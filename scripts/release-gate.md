...
- `npm run build`
- Supabase migrations applied, including the clinical, communications, and universal e-sign bucket hardening migrations
...
- Provider-backed email, SMS, phone, fax, support, AI, and e-sign flows pass runtime smoke tests
