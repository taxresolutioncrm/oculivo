...
check(inboundSmsFn.includes('provider_message_id')&&inboundSmsFn.includes('MessageSid')&&inboundSmsFn.includes('OCULIVO_SMS_FROM_NUMBER'),'Inbound SMS is idempotent and bound to the configured Oculivo destination number')
