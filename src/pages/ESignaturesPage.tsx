...
type Doc={id:string;title:string;signer_name:string;signer_email:string;status:string;sent_at?:string|null;opened_at?:string|null;last_viewed_at?:string|null;view_count?:number;signed_at?:string|null;declined_at?:string|null;decline_reason?:string|null;certificate_path?:string|null;audit?:AuditEvent[]}
